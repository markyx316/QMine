...
out=open(f"{SP}/sva_pv_weighted.txt","w")
...
out.close()
# (2) cleaning impact
out=open(f"{SP}/sva_clean_impact.txt","w")
...
out.close()
# (3) removed examples
out=open(f"{SP}/sva_tier_examples.txt","w")
...
for d,cat in CAT.items():
    ...
    for t in ["S1_system_repeated","S2_system_template","S3_card_passage","C1_content_free","C2_feed_control"]:
